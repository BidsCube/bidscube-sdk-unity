...
5. Optionally, specify a version tag: `https://github.com/Bidscube/bidscube-sdk-unity.git#v1.2.3`
6. Click `Add`
...
{
  "dependencies": {
    "com.bidscube.sdk": "https://github.com/Bidscube/bidscube-sdk-unity.git#v1.2.3"
  }
}
```
