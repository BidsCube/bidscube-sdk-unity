...
For a **pinned production** install, use release tag **`v1.2.9`** (matches published `package.json` version `1.2.9`):

`https://github.com/Bidscube/bidscube-sdk-unity.git#v1.2.9`

1. Open Unity Package Manager  
2. Click the "+" button and select "Add package from git URL"  
3. Paste the URL above, including the `#v1.2.9` fragment  
